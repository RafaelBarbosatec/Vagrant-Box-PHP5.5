      ...
      <td valign="middle" style='vertical-align: middle;'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:26;line-height: 39px;font-family: Helvetica Neue;'>
                              <h1 class='big'><a href="#" style='color:#444444'>Vagrant-Box-PHP5.5</a></h1>
                            </div>
                          </div>
                        </td>
    </tr>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">Hosts Ativos</h2>
                              <br>
                              <?php

                                  if($_SERVER['SERVER_NAME'] != $_SERVER['SERVER_ADDR']){
                                          echo "
                                  O vhost: <b>" . $_SERVER['SERVER_NAME'] . "</b> nao foi adicinado.<br />
                                  Para adicionar, acesse a box: <pre>vagrant ssh</pre> e adicione o vhost utilizando: <pre>addVhost</pre> usando o dominio: <b>" . $_SERVER['SERVER_NAME'] . "</b>
                                  </fieldset>";
                                  }else{
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              ...
                              echo 'Necessario adicionar manualmente o dns do Vhost desejado para o ip: ' . $_SERVER['SERVER_ADDR'] . '<br>'
                              ...
                              <a target='_blank' href="https://github.com/RafaelBarbosatec/Vagrant-Box-PHP5.5" class='link3' style='color:#555555;'>Github</a>
                              <br>
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <p>
                              By Rafael Almeida Barbosa<br/>
                              http://rafaelbarbosatec.github.io <br/>
                              </p>
                            </div>
                          </div>
                        </td>
